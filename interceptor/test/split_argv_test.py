...
class SplitArgvTests(unittest.TestCase):
    ...
    def test_single_file(self):
        parsed_cmd = SplitCompileCommand(self.CMD)
    ...
    def test_output_file(self):
        parsed_cmd = SplitCompileCommand(self.CMD + ' -o main')
        self.assertEqual(parsed_cmd.output_file, 'main')
        self.assertFalse(parsed_cmd.is_linker_command)

    def test_multi_files(self):
        parsed_cmd = SplitCompileCommand(self.CMD + " test.c")
    ...
    def test_linker_command(self):
        ...
        parsed_cmd = SplitCompileCommand(linker_cmd)
